...
function randomNum()
{
    ...
    loop3 = setInterval(function()
    {
      "use strict";
        ...
        {
            clearInterval(loop3);
            selector3.textContent = '${error.STATUS_CODE}'.substring(0,1);
        }else
        {
    ...
    loop2 = setInterval(function()
    {
      "use strict";
        ...
        {
            clearInterval(loop2);
            selector2.textContent = '${error.STATUS_CODE}'.substring(1,2);
        }else
        {
    ...
    loop1 = setInterval(function()
    {
      "use strict";
        ...
        {
            clearInterval(loop1);
            selector1.textContent = '${error.STATUS_CODE}'.substring(2,3);
        }else
        {
