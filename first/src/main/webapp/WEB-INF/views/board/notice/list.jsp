...
<div class="modal fade">
  <div class="modal-dialog">
	...
	<div class="text-center"><h1>${boardVO.name }</h1>
	<hr>
	<button class='btn btn-default' onclick='location.href="/board/${boardVO.boardType }/${boardVO.url }/list?showType=all"'>전체 보기</button>
	<button class='btn btn-default' onclick='location.href="/board/${boardVO.boardType }/${boardVO.url }/list?showType=default"'>안읽은 글 보기 (${readListTotCnt}개)</button>
	<hr>
	</div>
