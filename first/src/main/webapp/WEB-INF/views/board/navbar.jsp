...
<header>
		<nav class="navbar navbar-default navbar-expand-lg navbar-light">
			<div class="navbar-header d-flex col">
				<a class="navbar-brand" href="/"><b>홈</b></a>
			...
			<div id="navbarCollapse"
				...
				<ul class="nav navbar-nav">
					<c:forEach items="${menuList}" varStatus="status" var="menu">
						<c:if test="${menu.url eq '/board/list'.toString() }">
						<li class="nav-item" id="menu${menu.seq }"><a onclick="openNav();" href="#" class="nav-link">${menu.name }</a></li>
						</c:if>
						<c:if test="${menu.url ne '/board/list'.toString() }">
						<li class="nav-item" id="menu${menu.seq }"><a href="${menu.url }" class="nav-link">${menu.name }</a></li>
						</c:if>
					</c:forEach>
	...
	<c:forEach items="${menuList}" varStatus="status" var="menu">
		if(path.indexOf("${menu.url}") != -1)
			$("#menu${menu.seq}").addClass("active");
	</c:forEach>
