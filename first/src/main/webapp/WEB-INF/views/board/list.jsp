...
$(document).ready(function(){
	...
	$("#newBtn").on("click", function(){
		openPop($(this.form), "/board/writePage");
...
<div class="modal fade">
  <div class="modal-dialog">
	...
	<div class="text-center"><h1>읽지 않은 새 글</h1></div>
		<table class='table table-striped'>
			...
			<c:forEach items="${noticeVOList }" var="articleVO" varStatus="status">
				<tr>
					...
					<td>
						<form name='readForm' action='/board/readPage' method='post'
							id='readForm'>			
		...
		<hr>
	<form action="/board/list" method="post" name='searchForm' id='searchForm'>
			...
			<ul class="pagination">
				<c:if test="${pageMaker.prev}">
					<li class='page-item'><a class='page-link'
						href="/board/list${pageMaker.makeSearch(1)}">처음</a></li>
					<li class='page-item'><a class='page-link'
...
<%-- 						<c:out value="${pageMaker.pvo.page == idx?'class=page-item active':'' }"/>> --%>
				...
				<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
					<li class='page-item'><a class='page-link' href="/board/list${pageMaker.makeSearch(pageMaker.endPage+1)}">다음</a></li>
					<li class='page-item'><a class='page-link' href="/board/list${pageMaker.makeSearch(pageMaker.totalPage)}">마지막</a></li>
				</c:if>
