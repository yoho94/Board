...
<nav class="navbar navbar-default navbar-expand-lg navbar-light">
	...
	<div id="navbarCollapse" class="collapse navbar-collapse justify-content-start">
		<ul class="nav navbar-nav">
			...
			<li class="nav-item" id='board'><a href="/list" class="nav-link">게시판</a></li>
					<li>
		...
		<c:if test="${loginVO == null}">
			<li class="nav-item">
				<a data-toggle="dropdown" class="nav-link dropdown-toggle" href="#">로그인</a>
...
<!-- 							<div class="or-seperator"><b>or</b></div> -->
	...
	<script>
		...
		if (index > 0)
			...
			activeTab = url.substring(url.lastIndexOf("/"));
		console.log(url);
